...
async def resume() -> str:
    resume_path = Path("./ShreenarayanResume.pdf")

    if not resume_path.exists():
        return "ERROR: Resume file not found. Please ensure ShreenarayanResume.pdf is in the server directory."
    ...
    try:
        ...
        if not text_content.strip():
            text_content = (
                "ERROR: Resume appears to be empty or could not be extracted."
            )

        # Always inject your email explicitly
        email_header = """
# Shree Narayan

**Email:** narayanjaiswal030@gmail.com  
**Phone:** +91 9819280322  

---

"""
        final_markdown = email_header + text_content.strip()
